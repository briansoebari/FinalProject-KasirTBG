<?php
    ...
    $query = mysqli_query($koneksi, "SELECT nama_buku, Stok FROM barang");
                    ...
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner bg-faded text-center rounded">
                            <h2 class="section-heading mb-5">
                                <span class="section-heading-lower">Grafik</span>
                            </h2>
                            <!--Chart js-->
                            ...
                            <script>
                                ...
                                var myChart = new Chart(ctx, {
                                    type : 'bar',
                                    data : {
                                        labels : <?php echo json_encode($nama_buku)?>,
                                        datasets : [{
                                            label : 'Grafik Stok Buku',
                            ...
                            <br>
                            <h2 class="section-heading mb-5">
                                <span class="section-heading-lower">Laporan</span>
                            </h2>
                            <br>
                            <!--Bagian untuk mengunduh laporan-->
                            <a href="reportdataexcel.php">Laporan Transaksi bentuk Excel</a>
                            <br>
                            <a href="reportdatapdf.php">Laporan Transaksi bentuk PDF</a>
                        </div>
                    </div>
                </div>
            </div>
